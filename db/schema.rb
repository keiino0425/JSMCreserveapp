...
ActiveRecord::Schema.define(version: 2022_12_01_043628) do
  ...
  create_table "teachers", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.string "teacher_img", null: false
    t.string "teacher_address", null: false
    t.index ["email"], name: "index_teachers_on_email", unique: true
    t.index ["reset_password_token"], name: "index_teachers_on_reset_password_token", unique: true
  end

  create_table "temp_reservations", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "teacher_id", null: false
    t.datetime "start_time", null: false
    t.datetime "end_time", null: false
